<template>
  <div class="main-containers">
    <div class="top-container" style="box-shadow: 0 1px 0px rgba(64, 158, 255, .3); padding: 0px 0 0; margin: 0 auto; align-items: center; display: flex; right: 0; justify-content: space-around; overflow: hidden; top: 0; left: 0; background-color: #ceb44a; width: 100%; line-height: 64px; position: fixed; height: 64px; z-index: 1002;">
      ...
      <div v-if="true" :style='{"margin":"0 0 0 130px ","color":"#333","textAlign":"center","background":"none","display":"inline-block","width":"calc(100% - 370px)","fontSize":"28px"}'>智慧旅游平台</div>
      <div>
    ...
    <div class="body-containers" :style='"horizontal" == "vertical" ? {"minHeight":"100vh","padding":"64px 0 0","margin":"0 0 0 210px","position":"relative","background":"rgba(64, 158, 255, .3)","display":"block"} : {"minHeight":"100vh","padding":"64px 0 0","margin":"0","position":"relative","background":"#fff"}'>
      <div class="menu-preview" :style='{"padding":"0 ","borderColor":"#efefef","margin":"64px auto 0","top":"0","background":"url(http://codegen.caihongy.cn/20230204/13e68e581e9e42b7a53fd23ab9faef74.png) no-repeat left top /100% 100%,#d7eef2","borderWidth":"0","width":"100%","position":"fixed","borderStyle":"solid","height":"65px","zIndex":"1002"}'>
        <el-menu class="el-menu-horizontal-demo" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","background":"none","display":"flex","position":"relative","justifyContent":"center"}' :default-active="activeIndex" :unique-opened="true" mode="horizontal" :router="true" @select="handleSelect">
          <el-image v-if="false" :style='{"width":"44px","margin":"10px auto","objectFit":"cover","borderRadius":"100%","display":"block","height":"44px"}' src="http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg" fit="cover"></el-image>
                    ...
                    <el-menu-item v-for="(menu, index) in menuList" :index="index + ''" :key="index" :route="menu.url">
                      ...
                      <span :style='{"padding":"0 10px","lineHeight":"44px","fontSize":"16px","color":"inherit","height":"44px"}'>{{menu.name}}</span>
                    </el-menu-item>
...
<!--                      <span :style='{"padding":"0 10px","lineHeight":"44px","fontSize":"16px","color":"inherit","height":"44px"}'>后台管理</span>-->
<!--                    </el-menu-item>-->
                    <el-menu-item :index="menuList.length + 2 + ''" v-if="Token && notAdmin" @click="goMenu('/index/center')">
                      ...
                      <span :style='{"padding":"0 10px","lineHeight":"44px","fontSize":"16px","color":"inherit","height":"44px"}'>个人中心</span>
                    </el-menu-item>
                  </el-menu>
      </div>


                      <div class="banner-preview" :style='{"width":"100%","padding":"20px 20px 0","margin":"0","height":"450px"}'>
                        <el-carousel :style='{"width":"100%","margin":"0 auto"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="450px"  :autoplay="true" :interval="3000" :loop="true">
