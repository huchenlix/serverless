...
public class LvyouxianluController {
    ...
    public R count(@RequestParam Map<String, Object> params, LvyouxianluEntity lvyouxianlu, HttpServletRequest request){
...
//        }
        ...
        int count = lvyouxianluService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, lvyouxianlu), params), params));
