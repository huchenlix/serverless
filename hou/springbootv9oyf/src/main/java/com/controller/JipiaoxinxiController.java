...
public class JipiaoxinxiController {
    ...
    public R count(@RequestParam Map<String, Object> params, JipiaoxinxiEntity jipiaoxinxi, HttpServletRequest request){
...
//        }
        ...
        int count = jipiaoxinxiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jipiaoxinxi), params), params));
